...
urlpatterns = [ 
    ...
    path('emission-nom/<int:pk>/', view.read_emission_nom, name='read_emission_nom'),
    path('emission-nom/update/<int:pk>/', view.update_emission_nom, name='update_emission_nom'),
    path('emission-nom/delete/<int:pk>/', view.delete_emission_nom, name='delete_emission_nom'),

    # path('fuel_type/create_fuel/', view.create_fuel, name='create_fuel_type'),
    # path('fuel_type/get_all_fuel_list/', view.get_all_fuel_list, name='get_all_fuel_list'),
